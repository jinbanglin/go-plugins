...
var _Transport_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/jinbanglin/go-plugins/transport/grpc/proto/transport.proto",
}

func init() {
	proto.RegisterFile("github.com/jinbanglin/go-plugins/transport/grpc/proto/transport.proto", fileDescriptor0)
}
